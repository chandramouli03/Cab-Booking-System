...
def RegisterPage():
    ...
    global securityanswer
    canvas.delete('all')
    backgroundIMG=PhotoImage(file="cab6.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,100,430,550,fill="lightblue",outline="white")
    canvas.create_text(250,140,text="Register",fill='black',font=("italic",22,'bold',))
    ...
    Regbutton=Button(canvas,text="Register",width=10,fg="black",bg="yellow",font=("Arial",13,'bold'),command=RegisterNow)
    canvas.create_window(200,500,window=Regbutton)
    Loginbutton=Button(canvas,text="Login",fg="black",bg="yellow",bd=4,font=("Arial",13,'bold'),command=loginpage)
...
def feedpage():
    ...
    global feedEntry
    canvas.delete('all')
    jpgimg=PhotoImage(file="cab6.gif")
    canvas.create_image(0,0,image=jpgimg,anchor=NW)
    rebutton=Button(canvas,text="booking page",width=15,fg="black",bg="white",bd=0,font=("Arial",13,'bold'),command=gotocpage)
    canvas.create_window(1200,50,window=rebutton)
    ebutton=Button(canvas,text="Give Review",width=15,fg="black",bg="light green",font=("Arial",13,'bold'),command=submitreview)
    canvas.create_window(870,550,window=ebutton)
    canvas.create_text(683,100,text="Feedback" ,fill="white",font=("Arial",25,'underline'))
    canvas.create_text(700,300,text="Rating" ,fill="white",font=("Arial",13))
...
def cabbook():
    ...
    backgroundIMG=PhotoImage(file="login image.gif")
...
def adminloginpage():
    ...
    backgroundIMG=PhotoImage(file="cab6.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="lightgreen",outline="white")
    ...
    sbutton=Button(canvas,text="user section",width=10,fg="white",bg="#088",font=("Arial",13,'bold'),command=loginpage)
...
def changepasswordpage():
    ...
    backgroundIMG=PhotoImage(file="cab6.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(600,150,1000,550,fill="skyblue",outline="white")
    ...
    Resetbutton=Button(canvas,text="Reset Password",width=15,fg="white",bg="pink",font=("Arial",13,'bold'),command=changepass)
    canvas.create_window(700,450,window=Resetbutton)
    backbutton=Button(canvas,text="Back",fg="white",bg="pink",width=15,font=("Arial",13,'bold'),command=gotocpage)
...
def loginpage():
    ...
    backgroundIMG=PhotoImage(file="cab6.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="pink",outline="white")
    canvas.create_text(250,200,text="Login",fill='crimson',font=("times",25,'bold'))
    ...
    canvas.create_window(300,300,window=userEntered)
    canvas.create_window(300,350,window=passEntered)
    Loginbutton=Button(canvas,text="Login",width=10,fg="black",bg="lightyellow",font=("arial",13,'bold'),command=validate)
    canvas.create_window(210,450,window=Loginbutton)
    Regbutton=Button(canvas,text="Register",fg="black",bg="lightyellow",width=10,font=("Arial",13,'bold'),command=RegisterPage)
    canvas.create_window(350,450,window=Regbutton)
    forgbutton=Button(canvas,text="Forgot Password",fg="black",bg="lightyellow",bd=0,font=("Arial",10,),command=forgotpage)
    canvas.create_window(280,390,window=forgbutton)
    abutton=Button(canvas,text="Admin Login",fg="black",bg="lightyellow",bd=0,font=("Arial",10,'underline'),command=adminloginpage)
